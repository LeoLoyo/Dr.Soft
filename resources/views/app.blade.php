...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Dra.Anyibeth Rojas</a>
			</div>
	...
	{!! Html::script('bwer_components/bootstrap-material-design/dist/js/ripples.min.js') !!}
	{!! Html::script('bwer_components/bootstrap-material-design/dist/js/material.min.js') !!}
	<script>
